    ...
    L.Control.Loading = L.Control.extend({
      ...
      _showIndicator: function() {
        ...
        if (!this.options.separate) {
          if (this.zoomControl instanceof L.Control.Zoom) {
            ...
            typeof L.Control.Zoomslider === 'function' &&
            this.zoomControl instanceof L.Control.Zoomslider
          ) {
            L.DomUtil.removeClass(
      ...
      _handleBaseLayerChange: function(e) {
        ...
        if (
          e.layer &&
          e.layer.eachLayer &&
          typeof e.layer.eachLayer === 'function'
        ) {
      ...
      _layerAdd: function(e) {
        ...
        try {
          ...
          console.warn(
            'L.Control.Loading: Tried and failed to add ' +
              ' event handlers to layer',
            e.layer
          );
      ...
      _layerRemove: function(e) {
        ...
        try {
          ...
          console.warn(
            'L.Control.Loading: Tried and failed to remove ' +
              'event handlers from layer',
            e.layer
          );
          console.warn('L.Control.Loading: Full details', exception);
        }
